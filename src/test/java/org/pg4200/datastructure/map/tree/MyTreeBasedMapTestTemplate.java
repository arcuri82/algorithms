 ...
 */
public abstract class MyTreeBasedMapTestTemplate extends MyMapTestTemplate {

    @Override
    protected final <K extends Comparable<K>, V> MyMap<K, V> getInstance() {
        return getTreeInstance();
    }

    protected abstract <K extends Comparable<K>, V> MyTreeBasedMap<K, V> getTreeInstance();
